...
export const pagesContent = {
  home: {
    metadata: {
      title: 'See the work. Know who did it.',
      description: 'Ifixmultiservice pairs real photo galleries with the verified creator and business profiles behind them — proof of work, not just claims.',
      openGraphTitle: 'See the work. Know who did it.',
      openGraphDescription: 'Real galleries, tied to real profiles. Browse finished work and meet the people and businesses who actually did it.',
      keywords: ['work portfolio gallery', 'verified business profiles', 'proof of work', 'before and after gallery', 'creator profiles'],
    },
    hero: {
      badge: 'No stock photos. No filler bios.',
      title: ['See the work.', 'Know who did it.'],
      description: 'Every gallery here is tied to a real profile — the people and businesses who actually did the work. Skip the guesswork and browse proof instead of promises.',
      primaryCta: { label: 'Browse the work', href: '/image' },
      secondaryCta: { label: 'Meet the people', href: '/profile' },
      searchPlaceholder: 'Search work, people, and businesses',
      focusLabel: 'Focus',
    ...
    intro: {
      ...
      secondaryLink: { label: 'See latest', href: '/search' },
    },
    cta: {
